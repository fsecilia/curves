...
_Static_assert(sizeof(crv_capture_s32_t) == sizeof(s32), "crv_input_s32_t size mismatch");
_Static_assert(sizeof(crv_capture_u8_t) == sizeof(u8), "crv_input_u8_t size mismatch");
_Static_assert(sizeof(crv_capture_u16_t) == sizeof(u16), "crv_input_u16_t size mismatch");
_Static_assert(sizeof(crv_capture_u32_t) == sizeof(u32), "crv_input_u32_t size mismatch");
_Static_assert(sizeof(crv_capture_u64_t) == sizeof(u64), "crv_input_u64_t size mismatch");

#define CRV_IS_SIGNED_TYPE(type) (((type) - 1) < (type)1)
_Static_assert(CRV_IS_SIGNED_TYPE(crv_capture_s32_t) == CRV_IS_SIGNED_TYPE(s32), "crv_capture_s32_t sign mismatch");
_Static_assert(CRV_IS_SIGNED_TYPE(crv_capture_u8_t) == CRV_IS_SIGNED_TYPE(u8), "crv_capture_u8_t sign mismatch");
_Static_assert(CRV_IS_SIGNED_TYPE(crv_capture_u16_t) == CRV_IS_SIGNED_TYPE(u16), "crv_capture_u16_t sign mismatch");
_Static_assert(CRV_IS_SIGNED_TYPE(crv_capture_u32_t) == CRV_IS_SIGNED_TYPE(u32), "crv_capture_u32_t sign mismatch");
_Static_assert(CRV_IS_SIGNED_TYPE(crv_capture_u64_t) == CRV_IS_SIGNED_TYPE(u64), "crv_capture_u64_t sign mismatch");
