...
// baseline
static_assert(rsqrt<30, 30>(1ULL << 30) == (1ULL << 30));
...
static_assert(rsqrt<62, 62>(2795303719243043561ULL) == 5923455028186719836ULL);
