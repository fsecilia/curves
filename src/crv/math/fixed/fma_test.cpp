...
static_assert(fma<u16_0_t, saturate>(u16_0_t{300}, u16_0_t{300}, u16_0_t{0}, trunc)
              == u16_0_t::literal(max<uint16_t>()));
...
static_assert(fma<i16_4_t, wrap>(wide_int_t::literal(10000), wide_int_t::literal(10000),
