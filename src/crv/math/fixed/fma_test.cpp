...
constexpr auto fma(multiplicand_t multiplicand, multiplier_t multiplier, addend_t addend, rounding_mode_t rounding_mode)
    -> out_t
{
    return fma_t<out_t, saturate>{}(multiplicand, multiplier, addend, rounding_mode);
}
...
static_assert(fma<i64_31_t, true>(i64_31_t{200000}, i64_31_t{200000}, i64_31_t{0}, rne)
...
static_assert(fma<fixed_t<int32_t, 0>, true>(i32_1_t::literal(3), i32_1_t::literal(2), i32_1_t::literal(0), rne)
              == fixed_t<int32_t, 0>{2});

// 2.5 * 1.0 + 0 = 2.5; rne rounds down
static_assert(fma<fixed_t<int32_t, 0>, true>(i32_1_t::literal(5), i32_1_t::literal(2), i32_1_t::literal(0), rne)
              == fixed_t<int32_t, 0>{2});

// mixed-width type resolution
static_assert(fma<i64_31_t, true>(q4_t{10}, i32_15_t{100}, i64_31_t{50000}, rne) == i64_31_t{51000});
...
static_assert(fma<i32_15_t, true>(i32_15_t{2}, i32_15_t{3}, i32_15_t{4}, trunc) == i32_15_t{10});

// positive radix alignment boundary
// 5 * 5 = 25, + 1@q30 means (25 << 30) + (1 << 30) = 26 << 30
static_assert(fma<i32_0_t, true>(i32_0_t{5}, i32_0_t{5}, i32_30_t{1}, trunc).value == i32_0_t{26}.value);

// negative radix alignment boundary
// -5 * 5 = -25, + 1@q30 means -(25 << 30) + (1 << 30) = -24 << 30
static_assert(fma<i32_0_t, true>(i32_0_t{-5}, i32_0_t{5}, i32_30_t{1}, rne).value == i32_0_t{-24}.value);
