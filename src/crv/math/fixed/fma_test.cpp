...
static_assert(fma<i64_31_t, no_saturation>(i64_31_t{100}, i64_31_t{100}, i64_31_t{100}, rne) == i64_31_t{10100});
...
static_assert(fma<i32_15_t, no_saturation>(i32_15_t{2}, i32_15_t{3}, i32_15_t{4}, trunc) == i32_15_t{10});    // +*+ + +
static_assert(fma<i32_15_t, no_saturation>(i32_15_t{2}, i32_15_t{3}, i32_15_t{-4}, trunc) == i32_15_t{2});    // +*+ + -
static_assert(fma<i32_15_t, no_saturation>(i32_15_t{2}, i32_15_t{-3}, i32_15_t{4}, trunc) == i32_15_t{-2});   // +*- + +
static_assert(fma<i32_15_t, no_saturation>(i32_15_t{2}, i32_15_t{-3}, i32_15_t{-4}, trunc) == i32_15_t{-10}); // +*- + -
static_assert(fma<i32_15_t, no_saturation>(i32_15_t{-2}, i32_15_t{3}, i32_15_t{4}, trunc) == i32_15_t{-2});   // -*+ + +
static_assert(fma<i32_15_t, no_saturation>(i32_15_t{-2}, i32_15_t{3}, i32_15_t{-4}, trunc) == i32_15_t{-10}); // -*+ + -
...
static_assert(fma<i64_31_t, no_saturation>(i32_15_t{2}, i32_15_t{3}, i32_15_t{4}, trunc) == i64_31_t{10});
...
// massive overshoots
static_assert(fma<i32_15_t, saturate>(i32_15_t{1000}, i32_15_t{1000}, i32_15_t{0}, rne)
