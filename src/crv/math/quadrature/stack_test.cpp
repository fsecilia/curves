...
TEST_F(quadrature_stack_seeder_death_tests_t, critical_points_asserts_on_non_empty_stack)
{
    ...
    EXPECT_DEBUG_DEATH(sut.seed(stack, bisector, domain_max, global_tolerance, std::initializer_list{0.0}),
...
{
    EXPECT_DEBUG_DEATH(sut.seed(stack, bisector, domain_max, global_tolerance, std::initializer_list{-1.0}),
                       "in \\(0, domain_max\\)");
}
