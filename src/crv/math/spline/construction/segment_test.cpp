...
constexpr auto lesser
    = mesh_segment_t{.left = 0.0, .right = 0.0, .max_error = 1.0, .tolerance = 0.0, .depth = 0, .approximant = 0};
constexpr auto greater
    = mesh_segment_t{.left = 0.0, .right = 0.0, .max_error = 2.0, .tolerance = 0.0, .depth = 0, .approximant = 0};
