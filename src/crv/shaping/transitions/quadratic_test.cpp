...
template <typename scalar_t> struct test_t
{
    ...
    // interior midpoint
    static_assert(sut(scalar_t{0.5}) == scalar_t{0.125});
    ...
    // interior midpoint
    static_assert(sut(jet_t{scalar_t{0.5}, scalar_t{1.0}}) == jet_t{scalar_t{0.125}, scalar_t{0.5}});

    // chain rule, dy_dt * dt
    static_assert(sut(jet_t{scalar_t{0.5}, scalar_t{2.0}}) == jet_t{scalar_t{0.125}, scalar_t{1.0}});
