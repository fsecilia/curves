...
///
/// This type is currently participating in a temporary experiment to write timestamps back to the input stream. This
/// will only remain live until the driver pipeline proper comes online. Then writing timestamps back won't be
/// necessary and regions marked `dev-only absolute timestamp projection` can be removed.
