...
constexpr auto constant_lower_bound = static_lower_bound_t<value_t, -5>{};
static_assert(constant_lower_bound.min == constant_lower_bound(min<value_t>()));
static_assert(constant_lower_bound.min == constant_lower_bound(constant_lower_bound.min - 1));
static_assert(constant_lower_bound.min == constant_lower_bound(constant_lower_bound.min));
static_assert(constant_lower_bound.min + 1 == constant_lower_bound(constant_lower_bound.min + 1));
static_assert(0 == constant_lower_bound(0));
static_assert(max<value_t>() == constant_lower_bound(max<value_t>()));
