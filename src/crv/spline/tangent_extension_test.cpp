...
// safety proof
static_assert(sut_t{.slope = {.significand = 0, .shift = 0}, .y0 = y_t{3}, .x_max_delta = x_inf}.is_safe());
static_assert(!sut_t{.slope = {.significand = -1, .shift = 0}, .y0 = y_t{3}, .x_max_delta = x_inf}.is_safe());
static_assert(!sut_t{.slope = {.significand = 1, .shift = 0}, .y0 = y_t{3}, .x_max_delta = x_t::literal(-1)}.is_safe());
static_assert(!sut_t{.slope = {.significand = 1, .shift = 128}, .y0 = y_t{3}, .x_max_delta = x_t{1}}.is_safe());
static_assert(
    !sut_t{.slope = {.significand = 1, .shift = min<int_t>()}, .y0 = y_t{3}, .x_max_delta = x_t{1}}.is_safe());
