...
struct shaping_limited_curve_power_law_integration_test_t : Test
{
    using scalar_t = float_t;
    using jet_t = crv::jet_t<scalar_t>;
    using transition_t = transitions::smoothstep_t;
    using upper_t = transforms::upper_limiter_t<scalar_t, transition_t>;
    using lower_t = transforms::lower_limiter_t<scalar_t, transition_t>;
...
TEST_F(shaping_limited_curve_power_law_integration_test_t, nearby_supports_preserve_monotonic_order)
{
