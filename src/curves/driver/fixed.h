				     ...
				     unsigned int output_frac_bits)
{
	...
	// with the line `C0 - C1*x`. The constants are in Q2.62, so they're
	// scaled by 2^62 and rounded. The actual values are generated by
	// sollya. See src/curves/tools/isqrt_initial_guess.sollya for more
	// information.
