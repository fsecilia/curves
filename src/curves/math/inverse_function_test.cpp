...
const TestVector exp_vectors[] = {
    ...
    TestVector{"exp(e)", static_cast<real_t>(M_E), 1e-10},
    TestVector{"exp(pi)", static_cast<real_t>(M_PI), 1e-10},
...
const TestVector log_vectors[] = {
    ...
    TestVector{"log(e)", static_cast<real_t>(M_E), 1e-10},
    TestVector{"log(pi)", static_cast<real_t>(M_PI), 1e-10},
...
TEST_P(InverseFunctionTestInverseX, inverse_x) {
  ASSERT_NEAR(
      x, inverse_via_partition([](auto&& x) { return 1.0 / x; }, 1.0 / x),
      tolerance);
}

const TestVector inverse_x_vectors[] = {
    TestVector{"1/1", 1.0, 1e-10},
    TestVector{"1/e", static_cast<real_t>(M_E), 1e-10},
    TestVector{"1/pi", static_cast<real_t>(M_PI), 1e-10},
...
const TestVector offset_vectors[] = {
    TestVector{"0 + 10", 0.0, 1e-9},  // y is large
    TestVector{"5 + 10", 5.0, 1e-9},  // y is small
};
