...
FixedShrRtzS128EdgeCasesTestParam shr_rtz_s128_shift_0[] = {
    ...
    {S128_MAX + 0, 0, S128_MAX + 0},
    {S128_MAX - 1, 0, S128_MAX - 1},
    ...
    // boundary at min
    {S128_MIN + 1, 0, S128_MIN + 1},
    {S128_MIN + 0, 0, S128_MIN + 0},
};
...
TEST_P(NarrowS128ToS64Test, narrow) {
  ...
  const auto actual = curves_fixed_narrow_s128_s64(GetParam().wide);
...
const NarrowS128ToS64TestParam narrow_tests[] = {
    ...
    {S128_MAX, S64_MAX},           // Far beyond max saturates
    {S128_MIN, S64_MIN},           // Far beyond min saturates
};
