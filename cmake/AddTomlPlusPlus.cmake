...
if (USE_SYSTEM_TOMLPLUSPLUS)
  ...
  find_package(tomlplusplus
    ${TOML_MIN_VERSION}...<${TOML_MAX_VERSION} CONFIG REQUIRED)
  ...
  # library not found.
  find_package(tomlplusplus
    ${TOML_MIN_VERSION}...<${TOML_MAX_VERSION} CONFIG QUIET)
  ...
  if(tomlplusplus_FOUND)
    ...
    # Add subdirectory.
    add_subdirectory(${TOML_SUBMODULE_PATH}
      "${CMAKE_BINARY_DIR}/external/tomlplusplus")
  endif()
endif()
